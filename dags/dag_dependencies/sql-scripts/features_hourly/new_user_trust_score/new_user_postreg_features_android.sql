MERGE INTO core.new_user_score_android_postreg_features AS tgt USING (
    WITH user_ips_info_summary_features AS (
        SELECT
            username,
        ...
        FROM user_ips_info_android_tmp_{{ ts_nodash }}
    ...
    tmp_user_req_logs_aggregates AS (
        ...
        SELECT
            ...
            MIN(CASE
                WHEN LEN(SPLIT_PART(client_version, '.', 1)) = 2 AND REGEXP_LIKE(SPLIT_PART(client_version,'.',2), '[0-9]+')
    ...
    tmp_user_integrity_aggregates AS (
        ...
        SELECT
            username,
            MAX(CASE WHEN integrity:device_integrity LIKE '%MEETS_STRONG_INTEGRITY%' THEN 1 ELSE 0 END) strong_integrity_seen,
            MAX(CASE WHEN integrity:device_integrity LIKE '%MEETS_DEVICE_INTEGRITY%' THEN 1 ELSE 0 END) device_integrity_seen,
            MAX(CASE WHEN integrity:device_integrity LIKE '%MEETS_BASIC_INTEGRITY%' THEN 1 ELSE 0 END) basic_integrity_seen,
            MAX(CASE WHEN integrity:app_licensing::TEXT = 'LICENSED' THEN 1 ELSE 0 END) app_licensed_seen,
    ...
    tmp_user_ui_event_aggregates AS (
        WITH reg_device_ui_events AS (
            SELECT
                a.username,
                created_at,
                "payload.properties" pp
            FROM core.new_user_ui_events_android a
        ...
        SELECT
            ...
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'activate_sim' THEN 1 ELSE 0 END) num_ui_event_activate_sim,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'activation_status' THEN 1 ELSE 0 END) num_ui_event_activation_status,
            SUM(CASE WHEN pp:UITracking_Category::TEXT LIKE 'Activation%' THEN 1 ELSE 0 END) num_ui_event_Activation,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'App Inbox' THEN 1 ELSE 0 END) num_ui_event_app_inbox,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Area Code Selection' THEN 1 ELSE 0 END) num_ui_event_area_code_selection,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'AUTO_SIM' THEN 1 ELSE 0 END) num_ui_event_AUTO_SIM,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'BroadcastMessage' THEN 1 ELSE 0 END) num_ui_event_BroadcastMessage,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'CallToAction' THEN 1 ELSE 0 END) num_ui_event_CallToAction,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'ChangePassword' THEN 1 ELSE 0 END) num_ui_event_ChangePassword,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'ConversationList' THEN 1 ELSE 0 END) num_ui_event_ConversationList,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'credits_and_rewards' THEN 1 ELSE 0 END) num_ui_event_credits_and_rewards,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'CurrentWelcomeScreen' THEN 1 ELSE 0 END) num_ui_event_CurrentWelcomeScreen,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'free_port_number' THEN 1 ELSE 0 END) num_ui_event_free_port_number,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'free_wireless_v2' THEN 1 ELSE 0 END) num_ui_event_free_wireless_v2,
            SUM(CASE WHEN pp:UITracking_Category::TEXT LIKE 'iap?sku=%' THEN 1 ELSE 0 END) num_ui_event_iap_sku,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'InAppPurchase' THEN 1 ELSE 0 END) num_ui_event_InAppPurchase,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'lock_in_number' THEN 1 ELSE 0 END) num_ui_event_lock_in_number,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Login' THEN 1 ELSE 0 END) num_ui_event_Login,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Menu' THEN 1 ELSE 0 END) num_ui_event_Menu,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'my_offers' THEN 1 ELSE 0 END) num_ui_event_my_offers,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'NewWelcomeScreen' THEN 1 ELSE 0 END) num_ui_event_NewWelcomeScreen,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Number Results' THEN 1 ELSE 0 END) num_ui_event_Number_Results,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Number Selection' THEN 1 ELSE 0 END) num_ui_event_Number_Selection,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'OnboardingInfoDialogue' THEN 1 ELSE 0 END) num_ui_event_OnboardingInfoDialogue,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Paywall' THEN 1 ELSE 0 END) num_ui_event_Paywall,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Permissions' THEN 1 ELSE 0 END) num_ui_event_Permissions,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'PhoneNumberValidation' THEN 1 ELSE 0 END) num_ui_event_PhoneNumberValidation,
            SUM(CASE WHEN pp:UITracking_Category::TEXT LIKE 'premium%' THEN 1 ELSE 0 END) num_ui_event_premium,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Profile' THEN 1 ELSE 0 END) num_ui_event_Profile,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'ProPlanPrimer' THEN 1 ELSE 0 END) num_ui_event_ProPlanPrimer,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'purchase_sim' THEN 1 ELSE 0 END) num_ui_event_purchase_sim,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'receive_verification_code' THEN 1 ELSE 0 END) num_ui_event_receive_verification_code,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Registration' THEN 1 ELSE 0 END) num_ui_event_Registration,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'remove_ads_ad_plus' THEN 1 ELSE 0 END) num_ui_event_remove_ads_ad_plus,
            SUM(CASE WHEN pp:UITracking_Category::TEXT IN ('settings','Settings') THEN 1 ELSE 0 END) num_ui_event_settings,
            SUM(CASE WHEN pp:UITracking_Category::TEXT ILIKE 'settings?%' THEN 1 ELSE 0 END) num_ui_event_settings_subpage,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'SimPurchaseAndActivationScreen' THEN 1 ELSE 0 END) num_ui_event_SimPurchaseAndActivationScreen,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'SimPurchaseSuccessScreen' THEN 1 ELSE 0 END) num_ui_event_SimPurchaseSuccessScreen,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'SinglePageSIMOrderCheckout' THEN 1 ELSE 0 END) num_ui_event_SinglePageSIMOrderCheckout,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'support' THEN 1 ELSE 0 END) num_ui_event_support,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'textnow://show_caller' THEN 1 ELSE 0 END) num_ui_event_show_caller,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'TwoOptionEducation' THEN 1 ELSE 0 END) num_ui_event_TwoOptionEducation,
            SUM(CASE WHEN pp:UITracking_Category::TEXT = 'Voicemail' THEN 1 ELSE 0 END) num_ui_event_Voicemail
        FROM reg_device_ui_events
        GROUP BY 1
    ),

    tmp_user_device_fp_stats AS (
        WITH fp_user AS (
            SELECT username, a.device_fingerprint
            FROM (
                SELECT username, "bonus.Fingerprint" device_fingerprint
                FROM core.sketchy_registration_logs
                WHERE
                    (date_utc BETWEEN '{{ ds }}'::DATE - INTERVAL '3 MONTHS' AND '{{ ds }}'::DATE - INTERVAL '1 DAY')
            ...
            JOIN (
                ...
                WHERE
                    (execution_time = '{{ data_interval_start }}'::TIMESTAMP_NTZ)
                    AND (client_type IN ('TN_ANDROID', '2L_ANDROID'))
            ) b ON (a.device_fingerprint = b.device_fingerprint)
        ),

        device_fp_stats AS (
            SELECT
                device_fingerprint,
                COUNT(DISTINCT DATE(a.created_at)) num_days_device_fp_seen,
                COUNT(DISTINCT username) num_users_reg_device_fp,
                COUNT(DISTINCT CASE WHEN account_status='HARD_DISABLED' THEN username ELSE NULL END) num_users_disabled_reg_device_fp,
                COUNT(DISTINCT adid) num_devices_fp_seen,
                COUNT(DISTINCT CASE WHEN tracker_name ILIKE 'google%' AND tracker_name NOT ILIKE '%search%' THEN adid
                    ELSE NULL END) num_devices_google_nonsearch_ads,
                COUNT(DISTINCT CASE WHEN tracker_name ILIKE 'google%' THEN adid ELSE NULL END) num_devices_google_ads,
                COUNT(DISTINCT CASE WHEN tracker_name = 'Organic' THEN adid ELSE NULL END) num_devices_organic
            FROM fp_user
            JOIN core.users USING (username)
            LEFT JOIN (
                SELECT *
                FROM adjust.registrations
                WHERE (created_at BETWEEN '{{ data_interval_start }}'::TIMESTAMP_NTZ - INTERVAL '3 MONTHS'
        ...
        SELECT
            username,
            b.*,
            num_users_disabled_reg_device_fp::FLOAT/NULLIF(num_users_reg_device_fp, 0) pct_device_fp_users_disabled,
            num_devices_organic::FLOAT/NULLIF(num_devices_fp_seen, 0) pct_device_fp_organic,
            num_devices_google_ads::FLOAT/NULLIF(num_devices_fp_seen, 0) pct_device_fp_google_ads,
            num_devices_google_nonsearch_ads::FLOAT/NULLIF(num_devices_fp_seen, 0) pct_device_fp_google_nonsearch_ads
        FROM user_cohort_tmp_{{ ts_nodash }} a
        JOIN device_fp_stats b ON (a.device_fingerprint = b.device_fingerprint)
        WHERE (client_type IN ('TN_ANDROID', '2L_ANDROID'))
    ),
        ...
        FROM (
            WITH messages_flattened AS (
                ...
                FROM (
                    ...
                    JOIN user_cohort_tmp_{{ ts_nodash }} USING (user_id_hex)
                    WHERE
                        (inserted_timestamp BETWEEN '{{ data_interval_start }}'::TIMESTAMP_NTZ - INTERVAL '1 HOUR'
    ...
    SELECT
        ...
        user_ips_info_summary_features.num_ip,
        user_ips_info_summary_features.num_events_on_reg_ip,
        user_ips_info_summary_features.num_ip_countries,
        user_ips_info_summary_features.num_unsupported_ip_countries,
        user_ips_info_summary_features.num_asns,
        user_ips_info_summary_features.num_bad_asns,
        user_ips_info_summary_features.num_privacy_asns,
        user_ips_info_summary_features.num_privacy_ips,
        user_ips_info_summary_features.num_sub_divisions,
        ...
        tmp_user_integrity_aggregates.strong_integrity_seen,
        tmp_user_integrity_aggregates.device_integrity_seen,
        tmp_user_integrity_aggregates.basic_integrity_seen,
        tmp_user_integrity_aggregates.app_licensed_seen,
        ...
        tmp_user_ui_event_aggregates.num_ui_event_activation_status,
        ...
        tmp_user_ui_event_aggregates.num_ui_event_auto_sim,
        ...
        tmp_user_ui_event_aggregates.num_ui_event_currentwelcomescreen,
        ...
        tmp_user_ui_event_aggregates.num_ui_event_number_results,
        ...
        tmp_user_ui_event_aggregates.num_ui_event_support,
        ...
        tmp_user_device_fp_stats.num_days_device_fp_seen,
        tmp_user_device_fp_stats.num_users_reg_device_fp,
        tmp_user_device_fp_stats.num_users_disabled_reg_device_fp,
        tmp_user_device_fp_stats.num_devices_fp_seen,
        tmp_user_device_fp_stats.num_devices_google_nonsearch_ads,
        tmp_user_device_fp_stats.num_devices_google_ads,
        tmp_user_device_fp_stats.num_devices_organic,
        tmp_user_device_fp_stats.pct_device_fp_users_disabled,
        tmp_user_device_fp_stats.pct_device_fp_organic,
        tmp_user_device_fp_stats.pct_device_fp_google_ads,
        tmp_user_device_fp_stats.pct_device_fp_google_nonsearch_ads,
    ...
    LEFT JOIN user_ips_info_summary_features USING (username)
    ...
    LEFT JOIN tmp_user_device_fp_stats USING (username)
...
WHEN MATCHED THEN UPDATE SET
    ...
    tgt.strong_integrity_seen = src.strong_integrity_seen,
    tgt.device_integrity_seen = src.device_integrity_seen,
    tgt.basic_integrity_seen = src.basic_integrity_seen,
    tgt.app_licensed_seen = src.app_licensed_seen,
    ...
    tgt.num_ui_event_activation_status = src.num_ui_event_activation_status,
    ...
    tgt.num_ui_event_auto_sim = src.num_ui_event_auto_sim,
    ...
    tgt.num_ui_event_currentwelcomescreen = src.num_ui_event_currentwelcomescreen,
    ...
    tgt.num_ui_event_number_results = src.num_ui_event_number_results,
    ...
    tgt.num_ui_event_support = src.num_ui_event_support,
    ...
    tgt.num_days_device_fp_seen = src.num_days_device_fp_seen,
    tgt.num_users_reg_device_fp = src.num_users_reg_device_fp,
    tgt.num_users_disabled_reg_device_fp = src.num_users_disabled_reg_device_fp,
    tgt.num_devices_fp_seen = src.num_devices_fp_seen,
    tgt.num_devices_google_nonsearch_ads = src.num_devices_google_nonsearch_ads,
    tgt.num_devices_google_ads = src.num_devices_google_ads,
    tgt.num_devices_organic = src.num_devices_organic,
    tgt.pct_device_fp_users_disabled = src.pct_device_fp_users_disabled,
    tgt.pct_device_fp_organic = src.pct_device_fp_organic,
    tgt.pct_device_fp_google_ads = src.pct_device_fp_google_ads,
    tgt.pct_device_fp_google_nonsearch_ads = src.pct_device_fp_google_nonsearch_ads,
...
WHEN NOT MATCHED THEN INSERT VALUES (
    ...
    avg_px_score,
    num_px_vid,
    strong_integrity_seen,
    device_integrity_seen,
    basic_integrity_seen,
    app_licensed_seen,
    ...
    num_ui_event_currentwelcomescreen,
    ...
    num_ui_event_support,
    num_ui_event_show_caller,
    num_ui_event_twooptioneducation,
    num_ui_event_voicemail,
    num_days_device_fp_seen,
    num_users_reg_device_fp,
    num_users_disabled_reg_device_fp,
    num_devices_fp_seen,
    num_devices_google_nonsearch_ads,
    num_devices_google_ads,
    num_devices_organic,
    pct_device_fp_users_disabled,
    pct_device_fp_organic,
    pct_device_fp_google_ads,
    pct_device_fp_google_nonsearch_ads,
